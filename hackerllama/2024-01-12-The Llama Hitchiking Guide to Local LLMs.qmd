...
toc: false
twitter-card: true
title: The Llama Hitchiking Guide to Local LLMs大模型社区Llama便利指南
format:
  html:
    comments:
      utterances:
...
1. **LocalLlama:** 一个由从业者、研究人员和黑客组成的 [Reddit 社区](https://www.reddit.com/r/LocalLLaMA/)，他们使用机器学习模型进行各种疯狂的实践。

    ![](localllama.jpeg)

2. **LLM:** 大语言模型. Usually a transformer-based model with a lot of parameters...billions or even trillions.
